...
const QuestionDisplay = ({ onFinish }) => {
  ...
  return (
    <div className="bg-black flex items-center justify-center h-screen bg-gray-900 p-8">
      ...
      {/* New Box for Question Numbers on Right Side */}
      <div className="bg-gray-800 border border-gray-600 text-white rounded-lg shadow-lg p-4 ml-6 h-96 w-1/4">
        ...
        <div className="grid grid-cols-4 gap-2">
          {questions.map((_, index) => (
            <div
              ...
              className={`bg-gray-700 p-2 rounded cursor-pointer hover:bg-gray-600 transition text-center ${currentIndex === index ? 'bg-blue-500' : ''}`}
            >
